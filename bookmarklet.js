javascript: (async function gpa() {
    ...
    class Calculation {
        ...
        formatCoursesTableAndCreateResultTable() {
            ...
            $("#tbGPA").remove();
            let gpaFieldSet = $('<fieldset id="tbGPA"><legend>Thống kê GPA</legend><div id="tbGPA_wrapper" class="dataTables_wrapper" rold="grid"><table id="tbGPA" class="dkhp-table dataTable"><thead></thead><tbody role="alert" aria-live="polite" aria-relevant="all"></tbody></table></div><p style="margin-top: 10px; color: blue;"><strong>(*)</strong>: Nhấn Ctr+Shift+I và chọn tab Console để xem chi tiết tính toán.<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Thang điểm chữ và Thang điểm 4 được quy đổi dựa theo Sổ tay sinh viên năm học 2023-2024 và Bảng điểm tiếng Anh của Phòng Đào tạo.<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Nếu bạn thấy hữu ích, hãy tặng cho tác giả gốc một Star <a href="https://github.com/dtrung98/GPABookmarklet">Tại Đây</a> hoặc <a href="https://github.com/DreamyWanderer/GPABookmarklet_Maintanence">Tại Đây</a> nhé ^^<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Vui lòng báo lỗi hoặc kiến nghị <a href="https://github.com/DreamyWanderer/GPABookmarklet_Maintanence/issues">Tại Đây</a> </p></fieldset>');
